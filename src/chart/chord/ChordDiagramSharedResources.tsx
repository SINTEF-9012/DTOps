...
const ChordDiagramSharedResources = (props: ChartProps) => {
  ...
  for (const record of records) {
    ...
    try {
      if (record['_fields'][2].properties.name !== null) {
        const service = record['_fields'][2].properties.name;
  ...
  useEffect(() => {
    for (const record of records) {
      ...
      try {
        if (record['_fields'][2].properties.name !== null && record['_fields'][2].properties.name == chosenService) {
...
export default ChordDiagramSharedResources;
